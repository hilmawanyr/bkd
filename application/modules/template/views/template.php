<?php $data['group'] = $this->session->userdata('bkd_session')['group']; ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; 2020 <a href="http://ubharajaya.ac.id">Direktorat PTI Ubharajaya</a>.</strong> All rights
      reserved.
    </div>
    <!-- /.container -->
  </footer>
